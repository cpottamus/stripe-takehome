    ...
    <a href="#!">
      <div className="tile tile-centered">
        <figure className="avatar avatar-sm" style={{ backgroundColor: "#fff" }} >
          <img src={process.env.PUBLIC_URL + "/hotdogs/" + children + ".png"} alt={value} />
        </figure>
      ...
      >
        {({
          ...
          <div>
            ...
            >
              <button className="btn btn-primary" onClick={() => history.push('/shipping')} style={{marginTop: `4px`}}>
              ...
              <center>
                <img
                  ...
                  src={process.env.PUBLIC_URL + '/previews/' + this.state.lastSelected + ".png"}
                />
              </center>
          </div>
        )}
...
// STEP 1 -- get rendering similarly to DPS
// STEP 2, make sure your state is set up in index and passes to App correctly, for shipping.

// MUST INCLUDE THIS in Render
// <div class="columns">
...
//   <div class="column col-auto col-mx-auto">
//     <div id="react"></div>
//     <script type="text/javascript" src="/static/js/{{ live_client_js }}"></script>
//   </div>
// </div>